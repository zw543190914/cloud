//package com.zw.cloud.tools.ide.aop;
//
//import cn.hutool.core.util.StrUtil;
//import cn.hutool.crypto.SecureUtil;
//import com.alibaba.fastjson.JSON;
//import com.zw.cloud.tools.ide.annotation.Ide;
//import com.zw.cloud.tools.ide.enums.IdeTypeEnum;
//import com.zw.cloud.tools.ide.exception.IdeException;
...
//
//    @Pointcut("@annotation(com.zw.cloud.tools.ide.annotation.Ide)")
...
//                    Boolean result = redisService.tryLock(RID_REDIS_KEY_PREFIX + redisKey + rid, ide.timeOut(), ide.timeUnit());
//                    if (!result) {
...
//                Boolean result = redisService.tryLock(PARAMS_REDIS_KEY_PREFIX + redisKey + paramsKey, ide.timeOut(), ide.timeUnit());
//                if (!result) {
