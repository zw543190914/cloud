package com.zw.cloud.tools.utils.html.jsoup;
...
public class JsoupUtils {
    ...
    public static List<ImgAttachment> jsoupParseHtml(String html,List<ImgAttachment> result) throws IOException {
        Document doc = Jsoup.parse(html);
        jsoupParseDocument(doc,result);
        return result;
    }

    public static void jsoupParseDocument(Document doc,List<ImgAttachment> result) throws IOException {
        for (int i = 0; i < 20; i++) {
            ...
            for (Element l : li) {
                ...
                try {
                    ...
                    ImgAttachment imgDTO = new ImgAttachment();
