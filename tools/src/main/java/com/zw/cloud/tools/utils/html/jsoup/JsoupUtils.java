...
public class JsoupUtils {
    ...
    public static List<BaiduImgDTO> jsoupParseHtml(String html,List<BaiduImgDTO> result) throws IOException {
        Document doc = Jsoup.parse(html);
        jsoupParseDocument(doc,result);
        return result;
    }

    public static void jsoupParseDocument(Document doc,List<BaiduImgDTO> result) throws IOException {
        for (int i = 0; i < 200; i++) {
