package com.zw.cloud.activiti.config;
...
public class DemoApplicationConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService myUserDetailsService() {
        ...
        String[][] usersGroupsAndRoles = {
                ...
                {"a", "1234", "ROLE_ACTIVITI_ADMIN"},
                {"b", "1234", "ROLE_ACTIVITI_ADMIN"},
                {"c", "1234", "ROLE_ACTIVITI_ADMIN"},
                {"d", "1234", "ROLE_ACTIVITI_ADMIN"},
                {"e", "1234", "ROLE_ACTIVITI_ADMIN"},
                {"f", "1234", "ROLE_ACTIVITI_ADMIN"},
                {"001", "1234", "ROLE_ACTIVITI_ADMIN"},
        };
